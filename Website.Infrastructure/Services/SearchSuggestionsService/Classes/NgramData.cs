namespace Website.Infrastructure.Services.SearchSuggestionsService.Classes
{
    ...
    {
        protected static List<string> GetWords(string referenceWord, List<string> wordsList, List<KeyValuePair<int, int>> indexList)
        {
        ...
        private static int[] GetStartEndIndices(string referenceWord, List<string> words, List<KeyValuePair<int, int>> indexList)
        {
        ...
        // --------------------------------------------------------------------------------Get Edit Distance---------------------------------------------------------------
        private static float GetEditDistance(string str1, string str2)
        {
