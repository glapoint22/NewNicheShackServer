namespace Website.Infrastructure.Services.SearchSuggestionsService.Classes
{
    public sealed class Node
    {
        ...
        public Dictionary<int, List<SearchWordSuggestion>> Suggestions = new Dictionary<int, List<SearchWordSuggestion>>();
        ...
        public Node(List<SplitSearchTerm> splitSearchTerms, List<int> nicheIds)
        {
            Node rootNode = this;
