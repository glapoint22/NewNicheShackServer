...
{
    public partial class PublishItem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublishItems_Emails_EmailId",
                        column: x => x.EmailId,
                        principalTable: "Emails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishItems_Pages_PageId",
                        column: x => x.PageId,
                        principalTable: "Pages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishItems_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublishItems_EmailId",
                table: "PublishItems",
                column: "EmailId");

            migrationBuilder.CreateIndex(
                name: "IX_PublishItems_PageId",
                table: "PublishItems",
                column: "PageId");

            migrationBuilder.CreateIndex(
                name: "IX_PublishItems_ProductId",
                table: "PublishItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PublishItems_UserId",
                table: "PublishItems",
                column: "UserId");
        }
