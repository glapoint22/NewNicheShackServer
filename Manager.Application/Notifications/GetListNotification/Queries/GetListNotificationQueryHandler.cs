...
{
    public sealed class GetListNotificationQueryHandler : IRequestHandler<GetListNotificationQuery, Result>
    {
        private readonly IWebsiteDbContext _websiteDbContext;
        private readonly IManagerDbContext _managerDbContext;

        public GetListNotificationQueryHandler(IWebsiteDbContext websiteDbContext, IManagerDbContext managerDbContext)
        {
        ...
        public async Task<Result> Handle(GetListNotificationQuery request, CancellationToken cancellationToken)
        {
